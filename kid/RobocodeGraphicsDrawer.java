...
public class RobocodeGraphicsDrawer {
    ...
    private boolean isRobocode2K6 = false;
    ...
    public RobocodeGraphicsDrawer(Robot MyRobot, Graphics2D Graphics, boolean Robocde2K6) {
        this(MyRobot, Graphics);
        isRobocode2K6 = Robocde2K6;
        Height = 0.0;
        m1 = 1;
        m2 = 0;
    }
    ...
    public void drawLine(int x1, int y1, int x2, int y2) {
        Graphics.drawLine(x1, (int) (Height + m1 *y1), x2,
                (int) (Height + m1 *y2));
    }
    ...
    public void drawOval(int x, int y, int width, int height) {
        Graphics.drawOval(x, (int) (Height + m1 *(y + m2 * height)), width, height);
    }
    ...
    public void fillOval(int x, int y, int width, int height) {
        Graphics.fillOval(x, (int)(Height + m1 *(y + m2 * height)), width, height);
    }
    ...
    public void fillRect(int x, int y, int width, int height) {
        Graphics.fillRect(x, (int)(Height + m1 *(y + m2 * height)), width, height);
    }
    ...
    public void drawArc(int x, int y, int width, int height, int startAngle, int arcAngle) {
        Graphics.drawArc(x, (int) (Height + m1 *y), width, height, -startAngle + 90, -arcAngle);
    }
    ...
    public void drawString(String s, double x, double y) {
        Graphics.drawString(s, (float) x, (float) (Height + m1 *y));
    }

    // DONE
    public void drawString(String str, int x, int y) {
        Graphics.drawString(str, (int) (x), (int) (Height + m1 *y));
    }
    ...
    public void drawRect(int x, int y, int width, int height) {
        Graphics.drawRect(x, (int) (Height + m1 *(y + m2 * height)), width, height);
    }
