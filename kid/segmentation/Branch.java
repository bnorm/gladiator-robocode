...
public class Branch<E extends Segmentable, F extends Data, G extends Data> implements Cloneable, Serializable,
                                                                           Printable, Drawable {
   ...
   protected static <E extends Segmentable, F extends Data, G extends Data> boolean splitable(
                                                                                              LinkedList<E> dataList,
   ...
   protected void split(LinkedList<E> dataList, Segmenter<E, F, G>[] possibleSegmenters) {
      if (dataList == null || possibleSegmenters == null || dataList.size() == 0 || possibleSegmenters.length == 0)
         return;

      // double spikieness = 0.0D;

      for (int i = 0; i < possibleSegmenters.length; i++) {
