...
public class RobotInfo implements Cloneable, Serializable, Printable {
    ...
    */
   public final double angleTo(RobotData robot) {
      if (robot == null || robot.isDead())
         return Double.POSITIVE_INFINITY;
      return angleTo(robot.getX(), robot.getY());
   }
    ...
    */
   public final double angleTo(Point2D point) {
      if (point == null)
         return Double.POSITIVE_INFINITY;
    ...
    */
   public final double bearingTo(double angle) {
    ...
    */
   public final double bearingTo(double x, double y) {
      return bearingTo(angleTo(x, y));
   }
    ...
    */
   public final double bearingTo(RobotData robot) {
      if (robot == null || robot.isDead())
         return Double.POSITIVE_INFINITY;
      return bearingTo(angleTo(robot));
   }
    ...
    */
   public final double bearingTo(Point2D point) {
      if (point == null)
         return Double.POSITIVE_INFINITY;
      return bearingTo(angleTo(point));
   }
    ...
    */
   public final double distToSq(RobotData robot) {
      if (robot == null || robot.isDead())
         return Double.POSITIVE_INFINITY;
      return distToSq(robot.getX(), robot.getY());
   }
    ...
    */
   public final double distToSq(Point2D point) {
      if (point == null)
         return Double.POSITIVE_INFINITY;
      return distToSq(point.getX(), point.getY());
   }
    ...
    */
   public final double distTo(RobotData robot) {
      return Math.sqrt(distToSq(robot));
   }
    ...
    */
   public final double distTo(Point2D point) {
      return Math.sqrt(distToSq(point));
   }
