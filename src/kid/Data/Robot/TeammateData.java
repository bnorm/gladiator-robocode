...
public class TeammateData extends RobotData implements java.io.Serializable {
    ...
    public String toString() {
        return ("Name " + getName() + ", " + "Coordinates: " + "(" + (int) getX() + ", " + (int) getY() + ")" + ", "
                + "Heading: " + (int) getHeading() + ", " + "Velocity: " + (int) getVelocity()); // (+
                                                                                                    // "ALIAS:
                                                                                                    // " +
                                                                                                    // getAlias()
                                                                                                    // + ",
    ...
    public TeammateData(String name, double x, double y, double energy, double heading, double velocity,
            long time) {
        NAME = name;
    ...
    public TeammateData(Robot MyRobot) {
        ...
        updateItemFromFile(MyRobot.getX(), MyRobot.getY(), MyRobot.getEnergy(), MyRobot.getHeading(), MyRobot.getVelocity(), MyRobot.getTime());
    }
    ...
    public void updateItemFromFile(double x, double y, double energy, double heading, double velocity,
            long time) {
        ALIAS = ALIVE;
        X = x;
        Y = y;
