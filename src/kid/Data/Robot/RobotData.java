...
public abstract class RobotData implements java.io.Serializable {
    ...
    public abstract void updateItem(double x, double y, double dist, double energy, double heading, double velocity,
                                    long time);

    public abstract void updateItemFromFile(double x, double y, double dist, double energy, double heading,
