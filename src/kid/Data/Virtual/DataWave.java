...
public class DataWave extends VirtualWave {
    ...
    public DataWave(Robot MyRobot, EnemyData EnemyRobot, double FirePower, double[] MyRobotsSectors) {
        super(MyRobot.getX(), MyRobot.getY(), Utils.getAngle(MyRobot.getX(), MyRobot.getY(), EnemyRobot.getX(),
                EnemyRobot.getY()), FirePower, (Utils.sin(EnemyRobot.getHeading()
                - Utils.getAngle(MyRobot.getX(), MyRobot.getY(), EnemyRobot.getX(), EnemyRobot.getY())) * EnemyRobot
                .getVelocity()) < 0 ? -1 : 1, MyRobot.getGunHeat() == 0.0, MyRobot.getTime());
