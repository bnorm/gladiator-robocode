...
public class PatternMatchingPolar extends LogTargeting {
    ...
    public double getTargetingAngle(EnemyData EnemyRobot, double FirePower) {
        ...
        if (EnemyRobot != null) {
            ...
            int t = 0;
            try {
                Pattern start = EnemyRobot.getPattern();
                Pattern p = start;
                for (t = 0; Math.pow(t * BulletVelocity, 2) < Utils.getDistSq(mX, mY, eX, eY)
                        && p != null; t++) {
                ...
                // MyRobot.out.println("Processed Pattern with length of: " +
                // t);
    ...
    public void drawTargeting(RobocodeGraphicsDrawer g, EnemyData EnemyRobot, double FirePower) {
        ...
        if (EnemyRobot != null) {
            ...
            try {
                ...
                // g.drawRect((int) eX, (int) eY, (int) MyRobotsInfo.WIDTH,
