...
//        }
//        DataWave wave = new DataWave(MyRobot, EnemyRobot, FirePower, EnemyRobot.getSectors(FirePower));
//        double[] wave_sectors = wave.getSectors();
//
//        RobotVector evec = new RobotVector(ex, ey, eh, ev);
//        for (;; foreward_hit_time++) {
...
//        double angle = getTargetingAngle(EnemyRobot, FirePower);
//        double dist = i.DistTo(EnemyRobot);
//        double ex = Utils.getX(i.getX(), dist, angle);
//        double ey = Utils.getY(i.getY(), dist, angle);
//        g.setColor(Color.WHITE);
//        g.drawString(String.valueOf(EnemyRobot.getWaves().length), ex, ey);
