...
public class DataManager {
            ...
            if (i.isTeammate(SRE.getName())) {
                try {
                    ...
                    TeammateData[TeammateCount++] = new TeammateData(SRE.getName(), Utils.getX(i.getX(), SRE
                            ...
                            .getDistance(), SRE.getBearing() + i.getRobotFrontHeading()), SRE.getDistance(), SRE
                            .getEnergy(), SRE.getHeading(), SRE.getVelocity(), SRE.getTime());
                }
            } else {
                try {
                    ...
                    if (!updateEnemyDataFromFile(SRE)) {
                            EnemyData[EnemyCount] = new EnemyData(SRE.getName(), Utils.getX(i.getX(), SRE.getDistance(),
                                    ...
                                    SRE.getBearing() + i.getRobotFrontHeading()), SRE.getDistance(), SRE.getEnergy(), SRE
    ...
    public void drawTargetingNames(RobocodeGraphicsDrawer g) {
        ...
        for (int gun = VirtualGuns.length - 1, p = 0; gun >= 0; gun--, p++) {
            ...
            g.drawRect(1, 1 + (heighttofbox * p) + (1 * p), lenghtofbox,
                    heighttofbox);
            g.fillOvalCenter(sizeofcircul, (1 + heighttofbox / 2 + heighttofbox * p + 1 * p), sizeofcircul, sizeofcircul);
    ...
    public void drawTargetingNamesAndGraph(RobocodeGraphicsDrawer g) {
        ...
        for (int gun = 0; gun < VirtualGuns.length; gun++) {
            g.setColor(VirtualGuns[gun].getTargetingColor());
            g.drawRect(1, 1 + (heighttofbox * gun) + (1 * gun), lenghtofbox,
                    heighttofbox);
            g.fillOvalCenter(sizeofcircul, (1 + heighttofbox / 2 + heighttofbox * gun + 1 * gun), sizeofcircul, sizeofcircul);
            g.setColor(Colors.WHITE);
            g.drawString(VirtualGuns[gun].getNameOfTargeting(), 2 * sizeofcircul,
        ...
        for (int gun = 0; gun < VirtualGuns.length; gun++) {
            ...
            g.fillRect((int) (lenghtofbox + 35),
                    (1 + (heighttofbox * gun) + (1 * gun)), (int) rateing,
