...
public class Gladiator extends AdvancedRobot {
    ...
    private double getFirePower(EnemyData Enemy) {
        ...
        if (getOthers() > 1) {
            firepower *= i.DistToWall(i.getGunHeading())
                    / Utils.getDist(0.0, 0.0, i.getBattleFieldHeight(), i.getBattleFieldWidth()) * (i.getOthers());
        } else if (getOthers() == 1) {
            if (Data.getColsestEnemy().getTopVirtualGun() != null && Data.getColsestEnemy().getTopVirtualGun().getHitRate() >= 0.25)
    ...
    public void onWin(WinEvent e) {
        ...
        Data.getColsestEnemy().printVirtualGunStates(out);
    }
